...
export const homepageChooseItems = [
  {
  ...
  {
    title: "65 yaş aylığı için hızlı bir yön arıyorsanız",
    body:
      "65 Yaş Aylığı sayfası daha sade sorular ve daha büyük okunabilirlik ile ilerler.",
    href: "/65-yas-ayligi-uygunluk-testi",
    cta: "65 yaş testini aç",
  },
  {
